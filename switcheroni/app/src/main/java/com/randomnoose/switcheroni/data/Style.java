...
public enum Style {
  ...
  MODERN_ART("modern_art", R.drawable.style_02_modernart),
  INDIAN_ART("indian_art", R.drawable.style_03_indianart),
  THE_SCREAM("the_scream", R.drawable.style_04_scream),
  VAN_GOGH("van_gogh", R.drawable.style_05_vangogh),
